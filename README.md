...
Rootless image based upon the latest [Ubuntu LTS](https://hub.docker.com/_/ubuntu) providing the [MEGAcmd](https://github.com/meganz/MEGAcmd) server and its utilities.
